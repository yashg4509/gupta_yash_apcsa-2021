package unit9.activity79;

import java.util.List;

import unit9.activity13.Card;
import unit9.activity13.Deck;
...
public class ElevensBoard extends Board {
	 ...
	 */
	 ...
	 public boolean anotherPlayIsPossible() {
		List<Integer> selectedindexes = cardIndexes();
		if (!containsPairSum11(selectedindexes)) {
	...
	private boolean containsJQK(List<Integer> selectedCards) {
		...
		if (containsjack == true && containsqueen == true && containsking == true) {
			containsJQK = true;
